%    calculate_varian_geom_avg - Rationality_Measures Copyright (C) 2023  Lasse Mononen
%
...
function [value, cycles_in, cycle_sizes_in]  = calculate_varian_geom_avg(neighbors,...
    vertex_to_index, weights, cycles_in, cycle_sizes_in, max_removals)
% Non-normalized Varian's index of degree 0: The minimum cost of removals of out-edges
...
% the graph given by neighbors, vertex_to_index, and weights starting 
